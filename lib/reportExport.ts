...
function toHTML(d: ReportData): string {
    ...
    h1{color:#3a9295;margin:0 0 4px;font-size:22px;} .sub{color:#707783;font-size:12px;margin:0 0 16px;}
    h2{color:#3a9295;font-size:14px;margin:20px 0 6px;}
    table{width:100%;border-collapse:collapse;font-size:11px;} td,th{border:1px solid #e4e2e2;padding:6px 8px;text-align:left;}
    th{background:#3a9295;color:#fff;} td.k{font-weight:700;color:#3a9295;width:40%;}
    </style></head><body>
