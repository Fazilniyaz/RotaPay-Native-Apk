                                        ...
                                        <Card key={s.id} padding={0} style={styles.activeCard}>
                                            ...
                                            <View style={{ padding: 16 }}>
                                                ...
                                                <View style={styles.estStrip}>
                                                    ...
                                                    <View style={[styles.estCell, { borderLeftWidth: 1, borderLeftColor: 'rgba(0,94,163,0.08)' }]}>
...
const styles = StyleSheet.create({
    ...
    liveText: { fontSize: 9, fontFamily: FONTS.bold, color: '#047857', letterSpacing: 0.5 },
    elapsed: { fontSize: 38, fontFamily: FONTS.bold, color: COLORS.onSurface, textAlign: 'center', letterSpacing: 1 },
    estStrip: { flexDirection: 'row', backgroundColor: 'rgba(0,94,163,0.04)', borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(0,94,163,0.06)', padding: 10, marginVertical: 14 },
