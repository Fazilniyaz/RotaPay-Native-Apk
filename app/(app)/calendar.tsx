                    ...
                    <>
                        ...
                        {dayEntries(dayPopup).length === 0 ? (
                            ...
                            dayEntries(dayPopup).map((e) => (
                                <View key={e.id} style={[styles.entryRow, { backgroundColor: tint(e.color || '#3a9295') }]}>
                                    <Ionicons name={typeIcon[e.type] as any} size={16} color={e.color || '#3a9295'} />
                                    <Text style={[styles.entryRowTitle, { color: e.color || '#3a9295' }]} numberOfLines={1}>{e.title}</Text>
                                    <Text style={[styles.entryRowType, { color: e.color || '#3a9295' }]}>{e.type}</Text>
...
const styles = StyleSheet.create({
    ...
    chip: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, borderWidth: 1, borderColor: 'rgba(58,146,149,0.2)', borderRadius: RADIUS.md, paddingVertical: 11 },
    ...
    paidBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: 'rgba(16,95,104,0.1)', borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3 },
    paidText: { fontSize: 9, fontFamily: FONTS.bold, color: COLORS.secondary, letterSpacing: 0.4 },
    todayBtn: { borderWidth: 1, borderColor: 'rgba(58,146,149,0.2)', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3 },
    ...
    cell: { width: `${100 / 7}%`, minHeight: 62, padding: 3, borderWidth: 0.5, borderColor: 'rgba(58,146,149,0.06)' },
    cellOut: { backgroundColor: 'rgba(0,0,0,0.015)' },
    cellToday: { backgroundColor: 'rgba(58,146,149,0.10)', borderWidth: 1.5, borderColor: COLORS.primary },
    cellOpen: { backgroundColor: 'rgba(16,95,104,0.10)', borderWidth: 1.5, borderColor: COLORS.secondary },
    ...
    shiftDot: { backgroundColor: 'rgba(58,146,149,0.08)', borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1 },
    ...
    shiftRow: { flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1, borderColor: 'rgba(58,146,149,0.08)', borderRadius: RADIUS.sm, padding: 10, marginBottom: 8 },
    ...
    showBtn: { borderWidth: 1, borderColor: 'rgba(58,146,149,0.2)', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 6 },
    showBtnText: { fontSize: 10, fontFamily: FONTS.bold, color: COLORS.primary, letterSpacing: 0.5 },

    addNoteSection: { borderTopWidth: 1, borderTopColor: 'rgba(58,146,149,0.08)', marginTop: 14, paddingTop: 14 },
    addKindBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, borderWidth: 1, borderColor: 'rgba(58,146,149,0.2)', borderRadius: RADIUS.sm, paddingVertical: 12 },
    ...
    empOptionActive: { borderColor: COLORS.primary, backgroundColor: 'rgba(58,146,149,0.04)' },
    ...
    empInitial: { width: 36, height: 36, borderRadius: 8, backgroundColor: 'rgba(58,146,149,0.1)', alignItems: 'center', justifyContent: 'center' },
    empInitialText: { fontSize: 14, fontFamily: FONTS.bold, color: COLORS.primary },
    empDefaultBadge: { backgroundColor: 'rgba(16,95,104,0.1)', borderRadius: 8, paddingHorizontal: 6, paddingVertical: 2 },
    empDefaultText: { fontSize: 8, fontFamily: FONTS.bold, color: '#105f68', letterSpacing: 0.5 },

    paidRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 1, borderColor: 'rgba(16,95,104,0.2)', backgroundColor: 'rgba(16,95,104,0.04)', borderRadius: RADIUS.sm, padding: 10, marginBottom: 8 },
