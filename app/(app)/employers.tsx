                            ...
                            <Card key={emp.id} padding={0} style={styles.empCard}>
                                ...
                                <View style={{ padding: 16 }}>
                                    <View style={styles.empHead}>
                                        ...
                                        <View style={{ flex: 1 }}>
                                            <View style={styles.empNameRow}>
                                                ...
                                                <View style={[styles.statusDot, { backgroundColor: emp.isActive ? '#63c1bb' : COLORS.outlineVar }]} />
                                                {emp.id === defaultEmployerId && (
                                                    <View style={styles.defaultBadge}>
                                                        <Ionicons name="star" size={9} color="#105f68" />
                                    ...
                                    <View style={styles.statsStrip}>
                                        ...
                                        <View style={[styles.statCell, { borderLeftWidth: 1, borderLeftColor: 'rgba(58,146,149,0.08)' }]}>
                                    ...
                                    >
                                        {settingDefault === emp.id ? (
                                            <ActivityIndicator size="small" color="#105f68" />
                                        ) : (
                                            <Ionicons name={emp.id === defaultEmployerId ? 'star' : 'star-outline'} size={14} color="#105f68" />
                                        )}
...
const styles = StyleSheet.create({
    ...
    statsStrip: { flexDirection: 'row', backgroundColor: 'rgba(58,146,149,0.04)', borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(58,146,149,0.06)', padding: 10, marginBottom: 12 },
    ...
    defaultBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: 'rgba(16,95,104,0.1)', borderRadius: 10, paddingHorizontal: 6, paddingVertical: 2 },
    defaultBadgeText: { fontSize: 8, fontFamily: FONTS.bold, color: '#105f68', letterSpacing: 0.5 },
    defaultBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 10, borderRadius: RADIUS.sm, borderWidth: 1, borderColor: 'rgba(16,95,104,0.25)', marginBottom: 10 },
    defaultBtnActive: { backgroundColor: 'rgba(16,95,104,0.1)', borderColor: 'transparent' },
    defaultBtnText: { fontSize: 11, fontFamily: FONTS.bold, color: '#105f68', letterSpacing: 0.5 },
    empActions: { flexDirection: 'row', gap: 10 },
    editBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 10, borderRadius: RADIUS.sm, borderWidth: 1, borderColor: 'rgba(58,146,149,0.15)' },
    ...
    shiftRow: { flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: 1, borderColor: 'rgba(58,146,149,0.08)', borderRadius: RADIUS.md, padding: 12, marginBottom: 10 },
