...
const styles = StyleSheet.create({
    ...
    legendTotal: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: 'rgba(37,99,235,0.08)', paddingTop: 8, marginTop: 4 },
    ...
    payTrack: { height: 12, borderRadius: 6, backgroundColor: 'rgba(37,99,235,0.06)', overflow: 'hidden' },
