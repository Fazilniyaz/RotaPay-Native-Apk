...
const styles = StyleSheet.create({
    ...
    dataRowBorder: { borderBottomWidth: 1, borderBottomColor: 'rgba(2,69,122,0.06)' },
    ...
    exportOption: { flexDirection: 'row', alignItems: 'center', gap: 14, paddingVertical: 15, borderBottomWidth: 1, borderBottomColor: 'rgba(2,69,122,0.06)' },
